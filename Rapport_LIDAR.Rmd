...
bah c'est pas la bonne donc ça sert à rien
```{r}
...
Une autre piste a été envisagée dans la mesure ou l'automatisation de la détection n'aboutirait pas. Les couches traitées ont donc été exportées sur qgis sous format raster avec un opérateur interprétant les lignes visibles.
