...
La fonction `detect.cloiso()` est la fonction principale du code. 
```{r}
...
Il est probable que les cloisonnements soient détectés au même titre que des pistes forestières. il faudrait ajouter un traitement permettant de les discriminer
